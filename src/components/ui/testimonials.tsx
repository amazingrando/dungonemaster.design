...
export const testimonials: TestimonialProps[] = [
  ...
  {
    quote: "Randy is great with clients, delivers designs that are admired, can be relied upon in stressful situations to bring calm, and is great in a sales pitch!",
    author: "Suzy Bates",
  ...
  {
    quote: "When you work with Randy one thing you'll notice is that he is always on top of his game. He is an excellent communicator and has a respected voice in the industry.",
    author: "Scott Bell",
  ...
  {
    quote: "Collaborating with Randy on major website design projects is always an excellent experience. His designs are effective, not just beautiful.",
